                                             ...
                                             uint32_t row, uint32_t col)
{
    ...
    // 1|00000000000000|0|0|00|0|00000|0|0|0|00000
    // 1|00000000000000|0|0|00|0|00000|0|0|0|00000(23)
    addr = rank;

    // 1|00000000000000|0|0|00|0|00000|0|0|0|00000
    //  |00000000000000|0|0|00|0|00000|0|0|0|00000(22)
    addr <<= num_row_bit;
    addr |= row;

    // 1|00000000000000|0|0|00|0|00000|0|0|0|00000
    //                 |0|0|00|0|00000|0|0|0|00000(18)
    addr <<= num_col_high_bit;
    addr |= mask_by_bit(col, 4, 2);

    // 1|00000000000000|0|0|00|0|00000|0|0|0|00000
    //                   |0|00|0|00000|0|0|0|00000(17)
    addr <<= num_bank_high_bit;
    addr |= mask_by_bit(bank, 1, 1);

    // 1|00000000000000|0|0|00|0|00000|0|0|0|00000
    //                     |00|0|00000|0|0|0|00000(16)
    addr <<= num_bankgroup_bit;
    addr |= bankgroup;

    // 1|00000000000000|0|0|00|0|00000|0|0|0|00000
    //                        |0|00000|0|0|0|00000(14)
    addr <<= num_bank_low_bit;
    addr |= mask_by_bit(bank, 0, 0);

    // 1|00000000000000|0|0|00|0|00000|0|0|0|00000
    //                          |00000|0|0|0|00000(13)
    addr <<= num_chan_bit - 1;
